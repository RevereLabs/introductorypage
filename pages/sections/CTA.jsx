...
function CTA() {
  ...
  return (
    <div id='CTA' className="w-screen h-screen bg-textMain flex flex-col items-center font-mada font-[900] text-[4.8rem] w-[100%] leading-[4.8rem] small:h-auto">
        ...
        <input type="text" id="Mail" className='w-[20vw] h-[4vh] font-[500] text-[1.5rem] mt-10 drop-shadow-[5px_5px_0px_rgba(0,0,0,0.25)] small:w-[60vw]' placeholder='email Id' value={email} onChange={e => setEmail(e.target.value)}></input>
